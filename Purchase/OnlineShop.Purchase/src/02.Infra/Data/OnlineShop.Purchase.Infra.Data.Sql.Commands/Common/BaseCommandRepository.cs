...
internal abstract class BaseCommandRepository<TEntity, TId>(OnlineShopPurchaseCommandDbContext dbContext)
    where TEntity : AggregateRoot<TId>
{
    protected readonly OnlineShopPurchaseCommandDbContext DbContext = dbContext;
